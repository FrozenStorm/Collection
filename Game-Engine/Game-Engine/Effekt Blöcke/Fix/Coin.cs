...
namespace Game_Engine
{
    class Coin:Effekt
    {
        ...
        {
            this.punktegewinn = 10;
            this.transparent = false;
            this.classnumber = "Coin";
            this.life = 1;
            this.attack = 0;
            this.bild = new Bitmap(Properties.Resources.coin);
            this.Walkable = true;
            this.position_x = x;
            this.position_y = y;
        }
        public void Do_Effekt(Effekt[,] Mapeffekt, int Height, int Width, Input Myinput, int newdurchlauf)
        {
            ...
            {
                Mapeffekt[position_x, position_y] = new DernichtEffekt(position_x, position_y);
            }
        }
    }
}
